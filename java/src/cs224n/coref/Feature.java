...
public interface Feature {
	...
	public static class PairFeature implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof PairFeature
					&& ((PairFeature) o).content.equals(content);
		}
	...
	public static abstract class IntIndicator implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof IntIndicator
					&& o.getClass().equals(this.getClass())
	...
	public static abstract class BucketIndicator implements Feature {
		...
		public BucketIndicator(int value, int max, int numBuckets) {
			...
			if (bucket < 0 || bucket >= numBuckets) {
				throw new IllegalStateException("Bucket out of range: " + value
						+ " max=" + max + " numbuckets=" + numBuckets);
			}
		}
		...
		public String toString() {
			return this.getClass().getSimpleName() + "(" + bucket + "/"
					+ numBuckets + ")";
		}
	}
	...
	public static abstract class Placeholder implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof Placeholder
					&& o.getClass().equals(this.getClass());
		}
	...
	public static abstract class StringIndicator implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof StringIndicator
					&& o.getClass().equals(this.getClass())
	...
	public static abstract class SetIndicator implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof SetIndicator
					&& o.getClass().equals(this.getClass())
	...
	public static class HeadMatch extends Indicator {
		public HeadMatch(boolean headMatch) {
			super(headMatch);
		}
	}
	
	public static class GenderMatch extends Indicator {
		public GenderMatch(boolean match) {
			super(match);
		}
	}
	
	public static class NumberMatch extends Indicator {
		public NumberMatch(boolean match) {
			super(match);
		}
	}
	...
	public static class SentenceDistance extends IntIndicator {
		public SentenceDistance(int dist) {
			super(dist);
		}
	}

	public static class MentionDistance extends IntIndicator {
		public MentionDistance(int dist) {
			super(dist);
		}
	}
